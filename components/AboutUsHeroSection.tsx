...
export function AboutUsHeroSection() {
  return (
    <div className="relative w-full min-h-[75vh] sm:min-h-[80vh] lg:h-[calc(100vh-4rem)] flex items-center justify-center bg-[#1D3A2A] overflow-hidden">
      ...
      {/* Performance Tuned Background Media Engine */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/img/teak-care-section.png"
          alt="Premium timber workshop crafting high-end teak outdoor furniture collections"
          fill
          priority
          sizes="(max-width: 640px) 100vw, (max-width: 1280px) 90vw, 1280px"
          className="object-cover object-center"
        />
        {/* Anti-glare contrast veil overlay ensuring clear readability metrics */}
        <div className="absolute inset-0 bg-black/55 backdrop-blur-[0.5px]" />
      </div>

      {/* Primary Hero Text Deck Area */}
      <div className="relative z-10 mx-auto w-full max-w-5xl px-4 py-16 sm:px-6 lg:px-8 text-center">
        <div className="flex flex-col gap-4 sm:gap-6 items-center max-w-3xl mx-auto">
          ...
          {/* Action Interface Cluster - multi-tier viewport scaling control links */}
